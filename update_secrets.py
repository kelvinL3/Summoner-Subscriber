...
SECRETS = [
    Secret(
        name="RIOT_API_KEY",
        template="RGAPI-xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
        description="Riot Development API Key",
    ),
    Secret(
        name="LOG_DIRECTORY",
        template="/Users/ron/logs/",
        description="Folder where log outputs will be stored",
    ),
    Secret(
        name="DISCORD_TOKEN",
